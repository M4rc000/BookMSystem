<div class="container-scroller">
		<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
			<div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
				<a class="navbar-brand brand-logo mr-5" href="../../index.html"><img src="<?= base_url('assets'); ?>/images/logo.svg"
				...
				<div class="content-wrapper">
					<div class="row">
						<div class="col-lg grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<h4><strong>Table User Role</strong></h4>
										...
										<table class="table">
											...
											<tbody>
												<tr>
													...
													<td class="text-center">1</td>
													<td class="text-center"><a href="" class="badge badge-warning text-white"><i class="mdi mdi-wrench"></i></a> <a href="" class="badge badge-success"><i class="mdi mdi-pencil"></i></a> <a href="" class="badge badge-danger"><i class="mdi mdi-delete"></i></a></td>
												</tr>
											</tbody>
										</table>
									</div>
